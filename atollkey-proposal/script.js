document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ---------- Testimonial carousel (present only if markup exists) ---------- */
  ...
  bookingForm.addEventListener('submit', (e) => {
    ...
    formSuccess.textContent = `Thank you! Your enquiry for ${checkin.value} → ${checkout.value} has been noted — this concept form is not wired to a live inbox yet.`;
    bookingForm.reset();
    checkin.setAttribute('min', today);
    checkout.setAttribute('min', today);
  });
